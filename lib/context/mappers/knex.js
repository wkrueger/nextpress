...
const __1 = require("..");
exports.customKnexContext = (extraOpts = {}) => __1.createContextMapper({
    id: "default.knex",
        ...
        return {
            database: {
                ...
                db() {
                    let ctx = this;
                    if (!this._db) {
                        this._db = knex(Object.assign({ client: ctx.client, connection: {
                                host: ctx.host,
                                user: ctx.user,
                ...
                _checkMigrationVersions(migrations) {
                    let version = 0;
                    for (let x = 0; x < migrations.length; x++) {
                        ...
                        if (migration.version > version)
                            ...
                            throw Error("Error in the megrations versions sequence.");
                    }
                }
            }
        };
...
exports.knexContext = exports.customKnexContext({});
