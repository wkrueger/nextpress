...
class KnexStore extends UserStore {
    ...
    initStore() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._knex.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                if (!(yield trx.schema.hasTable(this.userTableName))) {
                    yield trx.schema.createTable(this.userTableName, table => {
                        table.increments();
                ...
                if (this.ctx.database._oldFwVersion < 2) {
                    yield trx.schema.alterTable(this.userTableName, table => {
                        table.string("username", 30).unique();
                    });
                    yield trx.table(this.userTableName).update({
                        username: trx.raw("??", ["email"])
                    });
                    if (this.ctx.database._oldFwVersion === 1) {
                        yield trx.schema.alterTable(this.userTableName, table => {
