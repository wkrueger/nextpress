...
const fs = require("fs");
const mailgun_1 = require("./server/contexts/mailgun");
const knex_1 = require("./server/contexts/knex");
const website_1 = require("./server/contexts/website");
const redis_1 = require("./server/contexts/redis");
const validateType = () => (i) => i;
exports.defaultMappers = validateType()({
