...
function buildscript(projectRoot) {
    ...
    const tasks = {
        scaffold() {
            ...
            checkNCreate(["server", "context.ts"], () => loadScaffoldFile("context.txt"));
            ...
            checkNCreate(["pages", "_app.tsx"], () => loadScaffoldFile("_app.txt"));
            checkNCreate(["pages-content", "_sass", "main.scss"], () => "");
            checkNCreate(["pages-content", "_common", "YupLocale.txt"], () => loadScaffoldFile("YupLocale.txt"));
